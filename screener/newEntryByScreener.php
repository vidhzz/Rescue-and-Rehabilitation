...
$info123 = "";
			...
			//	$dosu=$_POST["dosu"];
				...
				if($_POST["pic"] == "" || $_POST["iom"]=="" || $_POST["uam"]=="" || $_POST["fn"]=="" || $_POST["ln"]=="" || $_POST["fatname"]=="" || $_POST["motname"]=="" ||
				$_POST["dob"]=="" || $_POST["age"]=="" || $_POST["loc"]=="" || $_POST["edu"]=="" || $_POST["rn"]=="" || $_POST["dos"]=="" || $_POST["scid"]==""){
					$msg = "<p style='text-align:center;' ><font color='red'>Please Fill All The Fields!</font></p>";
				}
				else{
				$cnn = mysqli_connect("localhost","root","","RAR");
				if($count==0){
				$qry="insert into Child (Photo, IOM, UAM, RegistrationName, FirstName, LastName, FatherName, MotherName, DOB, Age, Gender, Locality, DoScreener, ScUserId, Education, Qualification)
				values ('$photo', '$iom', '$uam', '$rn', '$fn', '$ln', '$fatname', '$motname', '$dob', '$age', '$Gender', '$loc', '$dos', '$scid', '$edu', '$qua')";
				$cnn->query($qry);
	...
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="pic" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="iom" class="col-xs-10 col-sm-5" />
					<?php echo "$notIom"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="uam" class="col-xs-10 col-sm-5" />
					<?php echo "$notUam"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="rn" class="col-xs-10 col-sm-5" />
					<?php echo "$notRn"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="fatname" class="col-xs-10 col-sm-5" />
					<?php echo "$notFatn"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="motname" class="col-xs-10 col-sm-5" />
					<?php echo "$notMotn"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="date" id="form-field-1" name="dob" class="col-xs-10 col-sm-5" />
					<?php echo "$notDate"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="number" id="form-field-1" name="age" class="col-xs-10 col-sm-5" />
					<?php echo "$notAge"; ?>
				</div>
			</div>
			<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<input type="radio" id="form-field-1" name="gender" value="male"/> male
						 &nbsp;&nbsp;&nbsp;
						<input type="radio" id="form-field-1" name="gender" value="female"/> female
						<?php echo "$notGen"; ?>
					</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="loc" class="col-xs-10 col-sm-5" />
					<?php echo "$notLoc"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="number" id="form-field-1" name="scid" class="col-xs-10 col-sm-5" value="<?php echo $uid;?>"/>
					<?php echo "$notScid"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="edu" class="col-xs-10 col-sm-5" />
					<?php echo "$notEdu"; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="qua" class="col-xs-10 col-sm-5"/>
					<?php echo "$notQua"; ?>
				</div>
				<?php echo "$msg"; ?>
				<?php echo "$info123"; ?>
