...
//$notSuid = "";
          ...
          Gender='$Gender', Locality='$loc', Education='$edu', Qualification='$qua' where ChildId='$id' ";
		...
		<form class="form-horizontal" role="form" method="post">
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
						...
						<input class="btn btn-info" type="submit" name="submit" value="submit">&emsp;&emsp;&emsp;&emsp;
						<input class="btn btn-info" type="submit" name="reset" value="reset">&emsp;&emsp;&emsp;&emsp;
						<a href="searchForSupervisor.php">go back to searching page</a> /
						<a href="supervisor.php">go to home page</a> <br>
