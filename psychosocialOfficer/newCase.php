...
$pic = $_SESSION["pic"];
			...
			$qry12 = "select * from childcase";
			$result12 = $cnn->query($qry12);
			$str = "<div class='row'>";
			while($row12=$result12->fetch_assoc()){
				$cid = $row12["ChildId"];
			//	echo "cid = $cid";
				$qryy = "select * from childcase where childId='$cid'";
				$result23 = $cnn->query($qryy);
				$nor = mysqli_num_rows($result23);
				//echo "nor = $nor";
				if($nor==1){

					$qry="select * from child where ChildId='$cid'";
