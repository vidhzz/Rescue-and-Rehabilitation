...
<div class="row">
	<v class="col-xs-12"> 											<!-- PAGE CONTENT BEGINS -->									<form class="form-horizontal" role="form" method="post" >																					<div class="form-group">																						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">  </label>										<div class="col-sm-9">											<img height="200" width="200" class="center"  src="../pics/<?php echo "$pic"; ?>" >													</div>															<br><br>															<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> FirstName </label>								<div class="col-sm-9">
...
&nbsp; &nbsp; &nbsp;
<a href="psychosocialOfficer.php">Go to Display page</a>
</div>
				</div>
