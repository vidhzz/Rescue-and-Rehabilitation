...
if(isset($_POST["btn"])){
    ...
    if($count > 0 ){
        ...
        $childid=$row["ChildId"];
        $qry1="select * from childconference where ChildId='$childid' and csid='2' " ;
        ...
        if($count1>0){
            ...
            $msg="<font color='green'>Conference is incomplete or parents contact found!</font>";
        }
...
<div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="page-header">
                    <h1>
                    Search for the children whose conference is complete
