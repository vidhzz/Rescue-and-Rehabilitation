...
$pic = $_SESSION["pic"];
		...
		if(isset($_GET["btn"])){
			...
			$qry="select * from childtransportcase where ctsId='7'";
...
if($count1==0){
			if($cc!=0){
						...
						while($row1=$result->fetch_assoc()){
							...
							$qry1 = "select * from child where ChildId='$childid' and FirstName like 'AZ%'";
			...
			$info1 = "<script>alert('No Children found');</script>";
		}
}
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="get">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Search child by A to Z: </label>
