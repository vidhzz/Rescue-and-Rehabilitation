...
if(isset($_POST["btn"])){
    ...
    $qry="select * from child inner join childconference on child.ChildId=childconference.ChildId where (FirstName like '$alphabet%' or LastName like '$alphabet%') and childconference.csid='1'";
    if($count==0){
    $result = $cnn->query($qry);
        ...
        $msg="<font color='red'>no children entry found with conference incomplete!</font>";
      }
}
  }
if(isset($_POST["rst"])){
...
<div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="page-header">
                    <h1>
                        Search By A-Z whose conference is incomplete
