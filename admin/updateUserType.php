...
$pic = $_SESSION["pic"];
		...
		if(isset($_POST["btn"])){
			...
			if($count1==0){
						$qry="update usertype set UTypeName='$userName' where UTypeId='$userId'";
						$cnn->query($qry);
						header("location:displayUserType.php");
					}
		}
		...
		$cnn = mysqli_connect("localhost","root","","rar");
	    $userId = $_REQUEST["Id"];
	    $result=$cnn->query("Select * from usertype where UTypeId='$userId'");
	    $row=$result->fetch_assoc();
		$userName=$row["UTypeName"];
		}
	?>
<?php
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="UserName" class="col-xs-10 col-sm-5" value="<?php echo "$userName";?>" />
											<?php echo "$notUname";?>
										</div>
									</div>
